...
function show_embed_code_for_data(data) {
  ...
  var $pre = $('<pre></pre>')
    .text('<div id="' + id + '"></div><script src="//elections.huffingtonpost.com/2016/javascripts/pym.min.js"></script><script>new pym.Parent("' + id + '", "//' + window.location.host + window.location.pathname + '#' + encodeURIComponent(encoded) + '");(function(){var i=document.querySelector("#' + id + '>iframe");i.style.minWidth="100%";i.style.width="1px";})()</script>');
