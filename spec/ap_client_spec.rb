...
describe 'APClient' do
  ...
  describe '#fetch' do
    it 'should fetch the election-days list JSON' do
      ...
      expect(@subject.get(:election_days, nil, nil)).to eq('{}')
    end
    ...
    it 'should fetch the election-day JSON' do
      ...
      expect(@subject.get(:election_day, '2015-12-22', nil)).to eq('{}')
    end
    ...
    it 'should fetch the del_super JSON' do
      ...
      expect(@subject.get(:del_super, nil, nil)).to eq('{}')
    end
    ...
    it 'should send the etag if provided' do
      ...
      expect(@subject.get(:election_days, nil, 'ghijkl')).to eq('{}')
    end
