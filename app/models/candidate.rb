...
Candidate = RubyImmutableStruct.new(:database_or_nil, :id, :party_id, :full_name, :name, :n_delegates, :n_unpledged_delegates, :poll_percent, :poll_sparkline, :poll_last_update, :dropped_out_date) do
  include Comparable
